...
def ques_qwen(model_name, ques_str):
    messages = [
    ...
    with open(args.output_path, "w") as f:
        for item in dataset[split]:
            try:
                ...
                response = ques_qwen(args.model_name, prompt)
                ...
                evidence_response = ques_qwen(args.model_name, evidence_prompt)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, required="bookqa")
